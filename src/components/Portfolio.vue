        ...
        <div v-if="isModalOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div class="modal bg-white rounded-lg flex flex-col ">
                ...
                <div class="flex items-center justify-between px-8 mx-4 mb-4 gap-4">
                    <div class="p-2 hover:bg-slate-200 hover:rounded-full px-2 mr-2 mt-2 cursor-pointer" @click="prevImage">
                    ...
                    <div class="p-2 hover:bg-slate-200 hover:rounded-full px-2 mr-2 mt-2 cursor-pointer" @click="nextImage">
                        <svg fill="none" stroke="gray" stroke-width="1.5" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
